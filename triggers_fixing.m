...
eeglab
load('C:\Users\JulioMedeiros\Desktop\triggersinfor')
...
for i=27:length(files)
    ...
    if container_infor{files(i),3}==15
        ...
        EEG = pop_loadset('filename',container_infor{files(i),2},'filepath','C:\\Users\\JulioMedeiros\\Desktop\\analysis\\importfiles\\triggers\\');
        EEG = eeg_checkset( EEG );
    end
...
missing=input('Nº of 15 triggers missing?');
...
if gravar==1
    %%SAVE fixed
    EEG = pop_saveset( EEG, 'filename',container_infor{files(i),2},'filepath','C:\\Users\\JulioMedeiros\\Desktop\\analysis\\importfiles\\triggers\\');
    EEG = eeg_checkset( EEG );
...
%     EEG = pop_saveset( EEG, 'filename',container_infor{i,2},'filepath','C:\\Users\\JulioMedeiros\\Desktop\\analysis\\importfiles\\triggers\\problemas');
%     EEG = eeg_checkset( EEG );
    status=movefile(strcat('C:\Users\JulioMedeiros\Desktop\analysis\importfiles\triggers\',container_infor{files(i),2}),'C:\Users\JulioMedeiros\Desktop\analysis\importfiles\triggers\problemas')
    status=movefile(strcat('C:\Users\JulioMedeiros\Desktop\analysis\importfiles\triggers\',container_infor{files(i),2}(1:end-4),'.fdt'),'C:\Users\JulioMedeiros\Desktop\analysis\importfiles\triggers\problemas')
    clear notepad_15; clear notepad_inicio_event; clear EEG_inicio_event; clear duracao
end
end