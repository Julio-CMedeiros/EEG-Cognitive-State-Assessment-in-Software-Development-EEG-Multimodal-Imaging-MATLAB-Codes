...
% addpath(genpath(''C:\Users\JulioMedeiros\Desktop\neuroelf-matlab-master'))

vmr = xff('C:\Users\JulioMedeiros\Desktop\neuroelf-matlab-master\neuroelf-matlab-master\_files\colin\colin.vmr');

% voi_file = xff('voisSuspvsBaseline.voi');
voi_file = 'C:\Users\JulioMedeiros\Downloads\voisSuspvsBaseline.voi';

aux_boundingbox=xff('C:\Users\JulioMedeiros\Desktop\mapas_hrf_5\ID01_run1\ID01_run1_hrf_5_max_C1_abs_theta_relative_power.vmp');
...
for hrf_delay = 1:length(delays_hrf)
    ...
    cd(strcat('C:\Users\JulioMedeiros\Desktop\mapas_',delays_hrf{hrf_delay},'/'))
...
%                 correlation_values_per_voi_aux = correlation_values_per_voi( abs(correlation_values_per_voi) >= thresh) * 100;
    ...
    save(strcat('C:\Users\JulioMedeiros\Desktop\final_matrix_dice_adapted_coeff_',delays_hrf{hrf_delay},'.mat'),'final_matrix_real_dice','final_matrix_adapted_dice','final_matrix_nondice_EEG','final_matrix_nondice_VOI','correlation_matrix','significant_threshold_05','-v7.3')
end
