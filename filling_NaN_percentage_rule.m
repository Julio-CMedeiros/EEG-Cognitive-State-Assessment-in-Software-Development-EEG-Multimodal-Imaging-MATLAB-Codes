...
cd('C:\Users\JulioMedeiros\Desktop\dataset')
...
% for p=5
    ...
    cd(strcat('C:\Users\JulioMedeiros\Desktop\dataset\',name_file))
...
%             task_data= filloutliers(task_data,'linear','percentiles',[1 98],2); %ver outliers presentes em todas as features e usar linear
        ...
        mkdir('C:\Users\JulioMedeiros\Desktop\dataset_filled',name_file)
        save(strcat('C:\Users\JulioMedeiros\Desktop\dataset_filled\',name_file,'\',files_inside(pp).name),"data");
